...
var boarder_card_directive_1 = require("./boarder-card.directive");
var pokemon_type_color_1 = require("./pokemon-type-color");
...
var PokemonsModule = /** @class */ (function () {
    ...
    PokemonsModule = __decorate([
        core_1.NgModule({
            imports: [
                common_1.CommonModule, forms_1.FormsModule, pokemons_routing_module_1.PokemonRoutingModule
            ],
            declarations: [
                ...
                boarder_card_directive_1.BorderCardDirective,
                pokemon_type_color_1.PokemonTypeColorPipe
            ],
